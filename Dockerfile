...
CMD consul agent -data-dir=/tmp/consul -node-meta image:example-latest -datacenter automium -join consul-consul-server.default.svc.cluster.local & sleep 10 && ./app